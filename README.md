...
| Documento | Contenido |
|---|---|
| [docs/modelo-de-coste.md](docs/modelo-de-coste.md) | La física del cálculo, los factores por tecnología y sus límites |
| [docs/contabilidad.md](docs/contabilidad.md) | Partida doble, invariantes y por qué los saldos no pueden descuadrar |
| [docs/apis.md](docs/apis.md) | Contratos reales de las cuatro APIs externas, verificados, con sus trampas |
| [docs/despliegue.md](docs/despliegue.md) | Puesta en producción paso a paso, sin pagar nada |
